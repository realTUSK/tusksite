export default function Card({ matter }) {
    ...
    return(
        <a href={`/blog/${matter.slug}`}>
            <div className="flex flex-col w-[300px] h-[200px] gap-5 text-white border-2 border-white hover:border-tusklet hover:shadow-gray-400 hover:shadow-lg p-3">
