...
export default function Footer() {
    return(
        <footer className="flex flex-col lg:flex-row h-1/6 w-full p-5 gap-3 lg:gap-0 items-center justify-center">
            <h6 className="text-sm md:text-lg w-full text-gray-400 text-center">© Team T.U.S.K 2023. All rights reserved.</h6>
